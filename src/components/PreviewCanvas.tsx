          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{fit[0]}%</span>
              </div>
              <Slider
                value={fit}
      ...
      {outfit && (
        <Card className="p-4">
          <Button
            ...
            className="w-full mb-3 text-pink-600 border-pink-200 hover:bg-pink-50"
          >
            <Lightbulb className="w-4 h-4 mr-2" />
            {showSuggestions ? 'Hide' : 'Show'} Style Tips
          </Button>
          
          {showSuggestions && (
            <div className="space-y-2">
              {suggestions.map((suggestion, index) => (
                <div key={index} className="p-2 bg-pink-50 rounded-lg text-sm text-pink-700">
                  💡 {suggestion}
                </div>
              ))}
            </div>
